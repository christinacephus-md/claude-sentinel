...
# v7.0: PHI/PII detection — loaded from config/phi_patterns.json (single source of truth)
def _load_phi_patterns():
    """Load 18 HIPAA Safe Harbor patterns from shared config file."""
...
PHI_PATTERNS = _load_phi_patterns()
